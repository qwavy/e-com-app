...
export const HeaderUserActions = observer(() => {
    ...
    <div className={style['user-controls']}>
      ...
      {user ? (
        <div className={style.profile}>
          <Link to={Paths.Profile} className={style['button-link']}>
            <img className={style['profile-icon']} src={IconProfile} alt="Profile" />
          </Link>
          <button type="button" onClick={handleLogout} className={style['button-link']}>
            <img className={style['logout-icon']} src={IconLogout} alt="Logout" />
          </button>
        </div>
      ) : (
        <div className={style.profile}>
